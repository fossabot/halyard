...
public class SpinnakerMonitoringDaemonProfileFactory extends RegistryBackedProfileFactory {
  ...
  protected void setProfile(Profile profile, DeploymentConfiguration deploymentConfiguration, SpinnakerRuntimeSettings endpoints) {
    ...
    profile.appendContents(yamlToString(profile, metricStores));
    ...
    profile.appendContents(yamlToString(profile, serverConfig));
    ...
    profile.appendContents(yamlToString(profile, monitorConfig));
